...
class data_collection:
    ajay = pymongo.MongoClient("mongodb+srv://ajaykumar:ajay9095@cluster-1.npktwbc.mongodb.net/")
...
with st.sidebar:
    image_url = 'https://github.com/Ajay9095/Airbnb-Analysis/blob/main/airbnb_banner.jpg'
