...
def streamlit_config():
    ...
    # page configuration
    page_icon_url = 'https://github.com/Ajay9095/Airbnb-Analysis/blob/main/airbnb_logo.png'
...
class data_collection:
    ajay = pymongo.MongoClient("mongodb://bajaykumar:ajayroot@ac-0vdscni-shard-00-00.xdp3lkp.mongodb.net:27017,ac-0vdscni-shard-00-01.xdp3lkp.mongodb.net:27017,ac-0vdscni-shard-00-02.xdp3lkp.mongodb.net:27017/?ssl=true&replicaSet=atlas-11e4qv-shard-0&authSource=admin&retryWrites=true&w=majority")
    db = ajay['sample_airbnb']
...
class sql:
    ...
    def create_table():
        ajay = psycopg2.connect(host='localhost',
                                user='postgres',
                                password='root',
                                database='airbnb')
        cursor = ajay.cursor()
...
with st.sidebar:
    image_url = 'https://raw.githubusercontent.com/ajayashokan/Airbnb-Analysis/main/airbnb_banner.jpg'
